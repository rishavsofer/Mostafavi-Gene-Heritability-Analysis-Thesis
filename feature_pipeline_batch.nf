...
params.output_dir = "${params.base_dir}/output_production"
params.scripts_dir = "${params.base_dir}/scripts"
params.logs_dir = "${params.base_dir}/logs_production"
...
params.feature_start_column = 1
params.feature_end_column = 294
params.batch_size = 50
params.max_parallel_features = 20
params.test_mode = false
params.checkpoint_file = "${params.output_dir}/completed_features.txt"

params.feature_file = "${params.data_dir}/selected_1k_features.tsv"
...
workflow {
    feature_columns = Channel.from(params.feature_start_column..params.feature_end_column)
    ...
    ldsc_results
        ...
        .map { feature_name, chr_list ->
            [feature_name, chr_list.sort().join(',')]
        }
        .set { feature_results }

    heritability = compute_heritability(feature_results)
}
